    ...
    constructor(type) {
        ...
        this.componentProperty = {
            ...
            "button-fourPin": {
                ...
                width: 1,
                type: "button-fourPin",
                name: "Four Pin Button",
                value: null,
                colors: [new rgb(50, 50, 50), new rgb(191, 191, 191), new rgb(102, 102, 102), new rgb(255, 255, 255), new rgb(0, 0, 0)],
                rotation: 0,
                layer: 4,
                pins: [new pin(1, 1), new pin(3, 1), new pin(1, 4), new pin(3, 4)],
            },
            "button-twoPin": {
                height: 1,
                width: 1,
